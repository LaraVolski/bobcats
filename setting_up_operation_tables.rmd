...
phase1 <- read_csv("camera_operation_phase1.csv") %>% 
    ...
    select(-"Notes") %>% select(-"Operation") # drop notes column
phase2 <- read_csv("camera_operation_phase2.csv") %>% 
    rename(Start_2 = "Start", End_2 = "End", Problem1_from_2 = "Problem1_from", Problem1_to_2 = "Problem1_to", Problem2_from_2 = "Problem2_from", Problem2_to_2 = "Problem2_to") %>% select(-"Operation") %>%
...
all_phases <- all_phases %>% 
    rename(Start = "Start_1", End = "End_4", 
           ...
           Problem4_from = "Problem1_from_3", Problem4_to = "Problem1_to_4",
           ) %>% 
    select(Camera, Start, End, Latitude, Longitude, Problem1_from, Problem1_to, Problem2_from, Problem2_to, Problem3_from, Problem3_to, Problem4_from, Problem4_to)
